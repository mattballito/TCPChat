    ...
    while True:
        try:
            ...
            if message == 'NICK':
                ...
                # open to receive of session key
                ...
                if private_chat_active:
                    # check which algorithm is used for signature
                    # decrypt message
    ...
    while True:
        ...
        if message.startswith('INVITE'):
            ...
            if len(message.split(' ')) < 2:
                print("Invalid input. Please enter in the following format:\n\tINVITE <username>")
            else:
